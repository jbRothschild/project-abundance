...
NUM_TASKS_1=31 # Generally 40, maybe more?
NUM_TASKS_2=41
NUM_TASKS_ZERO=$((NUM_TASKS-1))

# multiLV model, varying parameters
VAR1=($(linspace 0.6 0.9 ${NUM_TASKS_1} | tr -d '[],'))
VAR1_NAME="comp_overlap"

VAR2=($(linspace 0.001 0.007 ${NUM_TASKS_2} | tr -d '[],'))
VAR2_NAME="immi_rate"
...
# 2 variable vary
parallel --joblog slurm-$SLURM_JOBID.log --sshdelay 0.1 --wd $PWD "python gillespie.py -m multiLV -t 1 -g 30000000 -n {#} -p ${VAR1_NAME}={1} ${VAR2_NAME}={2} max_gen_save=1000 sim_dir=${SIM_DIR}" ::: ${VAR1[@]} ::: ${VAR2[@]}
