...
parallel --joblog slurm-$SLURM_JOBID.log --sshdelay 0.1 --wd $PWD "python gillespie.py -m multiLV -t 1 -g 100000000 -n {#} -p birth_rate=2.0 death_rate=1.0 carry_capacity=100 ${VAR1_NAME}={1} ${VAR2_NAME}={2} max_gen_save=1000000 sim_dir=${SIM_DIR}" ::: ${VAR1[@]} ::: ${VAR2[@]}
