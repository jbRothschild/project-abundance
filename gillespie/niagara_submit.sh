...
parallel --joblog slurm-$SLURM_JOBID.log --wd $PWD "python gillespie.py -m multiLV -t 1 -g 500000 -n {#} -p birth_rate=20.0 death_rate=1.0 immi_rate=0.001 comp_overlap=0.8689 carry_capacity=100 max_gen_save=10000 sim_dir=${SIM_DIR}" ::: {001:400}
