...
# parallel -SAVE SOME STUFF --joblog slurm-$SLURM_JOBID.log -j $SLURM_TASKS_PER_NODE "python gillespie.py -m multiLV -t 1 -g 70000000 -n {#} -p ${VAR1_NAME}={1} ${VAR2_NAME}={2} max_gen_save=10000 sim_dir=multiLV0" ::: ${VAR1[@]} ::: ${VAR2[@]}
